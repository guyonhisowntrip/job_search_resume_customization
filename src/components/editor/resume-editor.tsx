    ...
    <Card className="overflow-hidden p-0">
      ...
      >
        ...
        <div className="flex items-center gap-3">
          {requiredCount > 0 ? <Badge tone="warning">{requiredCount} required</Badge> : null}
    ...
    <div className="mb-1.5 flex items-center justify-between gap-3">
      <label
        ...
        className={cn(
          ...
          isMissing ? "text-[#a94b34]" : "text-[#4d657f]"
        )}
      >
        {label} {required ? <span className={cn(isMissing ? "text-[#a94b34]" : "text-[#6f8398]")}>*</span> : null}
      </label>
      {warning ? (
...
export function ResumeEditor({ data, onChange, confidenceMap, missingPaths = [], compact = false }: ResumeEditorProps) {
  ...
  const missingPathSet = useMemo(() => new Set(missingPaths), [missingPaths])
  ...
  const requiredCounts = useMemo(() => {
    ...
    missingPaths.forEach((path) => {
      ...
      if (path.startsWith("experience.") || path === "experience|projects") {
        counters.experience += 1
      }
      if (path.startsWith("projects.") || path === "experience|projects") {
        counters.projects += 1
      }
  ...
  function isPathMissing(path: string) {
    return missingPathSet.has(path)
  }

  function fieldWarning(path: string) {
    if (isPathMissing(path)) {
      return "Required for deployment"
    }
    return confidenceMessage(confidenceMap, path)
  }

  function hasFieldError(path: string) {
    return isPathMissing(path) || Boolean(confidenceMessage(confidenceMap, path))
  }

  const needsExperienceOrProjects = isPathMissing("experience|projects")
  const needsSkills = isPathMissing("skills")
  ...
  return (
    <div className="space-y-4">
      <div className="rounded-xl border border-[#e2e9f2] bg-[#f8fbff] px-4 py-3 text-sm text-[#4a647f]">
        Fields marked with <span className="font-semibold text-[#24476a]">*</span> are required for deployment.
      </div>
      ...
      <SectionContainer
        ...
        requiredCount={requiredCounts.personal}
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div>
            <FieldLabel
              ...
              label="Full name"
              required
              isMissing={isPathMissing("personal.name")}
              warning={fieldWarning("personal.name")}
            />
            <Input
              id="name"
              hasError={hasFieldError("personal.name")}
          ...
          <div>
            <FieldLabel
              ...
              required
              isMissing={isPathMissing("personal.title")}
              warning={fieldWarning("personal.title")}
            />
            <Input
              id="title"
              hasError={hasFieldError("personal.title")}
          ...
          <div className="md:col-span-2">
            <FieldLabel
              ...
              label="Summary"
              required
              isMissing={isPathMissing("personal.summary")}
              warning={fieldWarning("personal.summary")}
            />
            <Textarea
              id="summary"
              hasError={hasFieldError("personal.summary")}
          ...
          <div>
            <FieldLabel
              ...
              label="Email"
              required
              isMissing={isPathMissing("contact.email")}
              warning={fieldWarning("contact.email")}
            />
            <Input
              id="email"
              hasError={hasFieldError("contact.email")}
          ...
          <div>
            <FieldLabel
              ...
              label="Location"
              required
              isMissing={isPathMissing("contact.location")}
              warning={fieldWarning("contact.location")}
            />
            <Input
              id="location"
              hasError={hasFieldError("contact.location")}
      ...
      <SectionContainer
        ...
        requiredCount={requiredCounts.experience}
        open={openSections.experience}
        onToggle={toggleSection}
      >
        <div className="space-y-4">
          {needsExperienceOrProjects ? (
            <div className="rounded-xl border border-[#efc7ba] bg-[#fff4ef] px-3 py-2 text-sm text-[#9c4b36]">
              Add at least one experience entry or one project to continue deployment.
            </div>
          ) : null}
              ...
              <div className="grid gap-3 md:grid-cols-2">
                <div>
                  <FieldLabel
                    ...
                    label="Company"
                    warning={fieldWarning(`experience.${index}.company`)}
                  />
                  <Input
                    id={`company-${index}`}
                    hasError={hasFieldError(`experience.${index}.company`)}
                    value={item.company}
                ...
                <div>
                  <FieldLabel
                    htmlFor={`role-${index}`}
                    label="Role"
                    warning={fieldWarning(`experience.${index}.role`)}
                  />
                  <Input
                    id={`role-${index}`}
                    hasError={hasFieldError(`experience.${index}.role`)}
                    value={item.role}
                ...
                <div className="md:col-span-2">
                  <FieldLabel
                    ...
                    warning={fieldWarning(`experience.${index}.description`)}
                  />
                  <Textarea
                    id={`description-${index}`}
                    hasError={hasFieldError(`experience.${index}.description`)}
          ...
          <Button
            ...
            className={cn(needsExperienceOrProjects ? "border-[#d26a53] text-[#9c4b36] hover:bg-[#fff4ef]" : "")}
          >
      ...
      <SectionContainer
        ...
        requiredCount={requiredCounts.projects}
      ...
      >
        <div className="space-y-4">
          {needsExperienceOrProjects ? (
            <div className="rounded-xl border border-[#efc7ba] bg-[#fff4ef] px-3 py-2 text-sm text-[#9c4b36]">
              No experience found yet. Adding one project here also satisfies the minimum requirement.
            </div>
          ) : null}
              ...
              <div className="grid gap-3 md:grid-cols-2">
                <div>
                  <FieldLabel
                    ...
                    label="Project name"
                    warning={fieldWarning(`projects.${index}.name`)}
                  />
                  <Input
                    id={`project-name-${index}`}
                    hasError={hasFieldError(`projects.${index}.name`)}
                    value={project.name}
                ...
                <div className="md:col-span-2">
                  <FieldLabel
                    ...
                    label="Description"
                    warning={fieldWarning(`projects.${index}.description`)}
                  />
                  <Textarea
                    id={`project-description-${index}`}
                    hasError={hasFieldError(`projects.${index}.description`)}
                ...
                <div className="md:col-span-2">
                  <FieldLabel
                    ...
                    warning={fieldWarning(`projects.${index}.tech`)}
                  />
                  <Input
                    id={`project-tech-${index}`}
                    hasError={hasFieldError(`projects.${index}.tech`)}
      ...
      <SectionContainer
        ...
        requiredCount={requiredCounts.skills}
      ...
      >
        <div className="space-y-3">
          {needsSkills ? (
            <div className="rounded-xl border border-[#efc7ba] bg-[#fff4ef] px-3 py-2 text-sm text-[#9c4b36]">
              Add at least one core skill before deployment.
            </div>
          ) : null}
          ...
          {data.skills.map((skill, index) => (
            <div key={`skill-${index}`} className="flex items-center gap-2">
              <Input
                hasError={needsSkills || Boolean(confidenceMessage(confidenceMap, "skills"))}
                value={skill}
          ...
          <Button
            variant="secondary"
            onClick={addSkill}
            className={cn(needsSkills ? "border-[#d26a53] text-[#9c4b36] hover:bg-[#fff4ef]" : "")}
          >
            <Plus className="mr-1.5 h-4 w-4" />
            Add Skill
          </Button>
