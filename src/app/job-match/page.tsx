...
import { downloadTechResumeTemplate } from "@/lib/resume-export"
...
export default function JobMatchPage() {
  ...
  function handleDownloadImproved() {
    ...
    try {
      const fileName = downloadTechResumeTemplate(improvedResume)
      setNotice(`Downloaded improved resume PDF: ${fileName}`)
    } catch (downloadError) {
      setActionError(normalizeErrorMessage(downloadError, "Could not download improved resume"))
    }
  }
  ...
  return (
    <WizardShell
      ...
      description="Run LangChain-powered job fit analysis against a real job description, review regenerated content, and apply improvements safely."
      actions={
          ...
          {isLoading ? (
            ...
            >
              ...
              <ResumeDiffView
                ...
                onDownloadImproved={handleDownloadImproved}
